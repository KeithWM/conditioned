...
mat = matrices.Matrices(tau, beta, gamma, p_dist, N, upsilon, compute_expm=True)
...
ou2 = scipy.sqrt(gamma*N*(1-ou1**2)/(2*beta*theta*tau))
ou2[0] = 0#scipy.sqrt( 2*gamma*N/(beta*tau) )
